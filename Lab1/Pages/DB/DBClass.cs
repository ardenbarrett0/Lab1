...
namespace Lab1.Pages.DB
{
    public class DBClass
    {
        ...
        public static void InsertQueue(int QueueID, int QueueOrder, int FacultyID, int StudentID)
        {

            string loginQuery =
                "INSERT INTO Queue (queueID, queueOrder, facultyID, studentID) values (@queueID, @queueOrder, @facultyID, @studentID)";
            ...
            cmdLogin.CommandText = loginQuery;
            cmdLogin.Parameters.AddWithValue("@queueID", QueueID);
            cmdLogin.Parameters.AddWithValue("@queueOrder", QueueOrder);
            cmdLogin.Parameters.AddWithValue("@facultyID", FacultyID);
